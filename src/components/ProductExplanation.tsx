...
const premiumFeatures = [
  ...
  "עריכת וידאו מתקדמת – עריכה עשירה יותר עם מעברים יצירתיים, צבעים מותאמים, שילוב קטע קצר לשיתוף ברשת",
  "מגנט פיזי – שליחת הסרטון על דיסק און קי בעיצוב אישי",
  "קטעי אודיו נבחרים עם מוזיקה, רגעים מרגשים – כמו פספול מתוך הברכות",
  "קובץ דיגיטלי להורדה + גיבוי בענן",
  "שלט אישי עם שם הזוג",
];
...
const ProductExplanation: React.FC = () => (
  <section
    className="container py-16 bg-pink-50 px-4 md:px-12 text-right"
    dir="rtl"
    id="order"
  >
